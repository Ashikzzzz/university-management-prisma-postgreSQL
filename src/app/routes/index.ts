...
import { stuentEnrolledCourseMarkRoute } from '../modules/studentEnrolledCourseMark/studentEnrolledCourseMark.route';
...
const moduleRoutes = [
  ...
  {
    path: '/student-course-mark',
    route: stuentEnrolledCourseMarkRoute,
  },
];
